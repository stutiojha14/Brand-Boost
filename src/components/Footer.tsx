      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground">
              Transform references into brand-perfect creative with our AI-powered
              advertising platform. Generate content, build ads, and gain insights.
            </p>
          </div>
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/analytics" className="text-muted-foreground hover:text-foreground transition-colors">Analytics</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="border-t mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} BrandBoost AI. All rights reserved.
          </p>
